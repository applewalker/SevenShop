...
public class CaptureActivity extends Activity implements Callback {
	...
	public void handleDecode(String result) {
		...
		if(Item[0].equals("7shop")){
			Toast.makeText(getApplicationContext(), Item[2], Toast.LENGTH_SHORT).show();
			
			/**
			 * 跳转处理
			 */
			Intent intent=new Intent(CaptureActivity.this,CommodityActivity.class);
			intent.putExtra("id", Integer.valueOf(Item[2]));
			startActivity(intent);
		}else{
			Toast.makeText(getApplicationContext(), "非应用商品信息!", Toast.LENGTH_SHORT).show();
		}
